...
from utils import ResearchPaper, search_relevent_arxiv, search_new_arxiv, download_papers
...
log_file = os.path.join(log_directory, "llm_research.log")
...
class AnalysisResult:
    ...
    focus_areas: List[ResearchTopics]
    raw_response: str
    timestamp: str = ""
...
# Going to work on making the process for concurrent with threads
class ConcurrentResearchManager:
    ...
    def analyze_research(self, research: str) :
    ...
    def _get_research_topics(self, research: str, max_retries: int = 3)-> List[ResearchTopics]:
    ...
    def _parse_research_topics(self, response: str)-> List[ResearchTopics]:
        """
        Parses the response into a list of research focus areas
        Args:
        ...
        for line in lines:
            ...
            # Check if line contains priority
                ...
                research_topics.append(ResearchTopics(
                    topic=current_topic,
                    priority=priority
                    ))
    ...
    def _get_research_queries(self, research_topics: List[ResearchTopics]):
        try:
    ...
    def _get_papers(self, research_topics: List[ResearchTopics]):
    ...
    def _check_title_relevance(self, papers, research_topics: List[ResearchTopics], max_titles = 6):
        ...
        try:
            ...
            raise e
    def _check_abstract_relevence(self, papers, research_topics: List[ResearchTopics], indices_list: List[List[int]]):
